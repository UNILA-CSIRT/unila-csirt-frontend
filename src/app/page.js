...
export default function HomePage() {
  const incidentLogData = [
    {
      id: 1,
      dateTime: "10/04/2025 - 13:21",
      websiteName: "Sistem Akademik Unila",
      domain: "siakadu.unila.ac.id",
      type: "Brute Force Login",
      status: "Baru",
    },
    {
      id: 2,
      dateTime: "09/04/2025 - 10:14",
      websiteName: "Sistem Perpustakaan",
      domain: "library.unila.ac.id",
      type: "Directory Transversal",
      status: "Dalam Proses",
    },
    {
      id: 3,
      dateTime: "08/04/2025 - 22:11",
      websiteName: "Website FT",
      domain: "teknik.unila.ac.id",
      type: "Malware Injection",
      status: "Dalam Proses",
    },
    {
      id: 4,
      dateTime: "08/04/2025 - 18:40",
      websiteName: "Website FISIP",
      domain: "fisip.unila.ac.id",
      type: "Website Deface",
      status: "Selesai",
    },
    {
      id: 5,
      dateTime: "07/04/2025 - 07:33",
      websiteName: "Website Informatika",
      domain: "inf.unila.ac.id",
      type: "Phising Attempt",
      status: "Selesai",
    },
  ];
        ...
        <section className="bg-primary-dark text-text-white">
          <div className="container mx-auto px-6 py-20 lg:py-32 flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 text-center lg:text-left mb-10 lg:mb-0">
              ...
              <h2 className="text-2xl md:text-3xl text-primary-teal font-bold mt-2">
                UNIVERSITAS LAMPUNG
              </h2>
              <p className="mt-6 text-lg text-gray-300 max-w-lg mx-auto lg:mx-0">
                Tim respons insiden keamanan siber Universitas Lampung yang
                bertugas untuk menerima, meninjau, dan menanggapi laporan
              ...
              <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-md flex flex-col">
                <div className="flex flex-1 gap-4">
                  <div className="flex-grow flex flex-col">
                    <div className="flex-grow flex items-end justify-around gap-2 text-center border-l border-b border-gray-200 pl-1">
                      {[
                        ...
                        <div
                          key={month}
                          className="h-full w-full flex items-end justify-center gap-1"
                        >
                          <div
                          ...
                          ></div>
                          <div
                            className="w-3 bg-primary-teal rounded-t-sm"
                            style={{ height: `${values[1]}%` }}
                          ></div>
                          <div
                            className="w-3 bg-primary-dark rounded-t-sm"
                            style={{ height: `${values[2]}%` }}
                          ></div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="w-32 flex flex-col justify-start space-y-2 text-xs pt-2">
                    ...
                    <div className="flex items-center text-black">
                      <span className="w-3 h-3 bg-primary-teal mr-2 rounded-sm "></span>
                      Konten Negatif
                    </div>
                    <div className="flex items-center text-black">
                      <span className="w-3 h-3 bg-primary-dark mr-2 rounded-sm"></span>
                      Keamanan
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white p-8 border border-gray-200 rounded-lg shadow-md">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {facultyData.map((faculty) => (
                  ...
                  >
                    <span className="font-semibold text-sm w-2/3">
                      {faculty.name}
                    </span>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-md">
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            <span
                              className={`w-2.5 h-2.5 rounded-full mr-2 ${getStatusDotClass(
                                item.status
                              )}`}
                            ></span>
                            {item.status}
              ...
              <div className="flex justify-end mt-4">
                <a
                  href="#"
                  className="text-sm font-medium text-gray-500 hover:text-primary-dark hover:underline"
                >
                  Lihat Selengkapnya
                </a>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="md:w-1/2 text-center md:text-left">
                  <h3 className="text-2xl lg:text-3xl font-bold leading-tight">
                    Butuh bantuan cepat soal insiden keamanan atau tips menjaga
                    data tetap aman? Chat dengan Asisten CSIRT AI sekarang juga!
                  </h3>
                </div>
