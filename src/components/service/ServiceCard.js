...
export default function ServiceCard({ service }) {
  ...
  const rightBoxBgClasses = "bg-gradient-to-br from-[#13686D] to-[#081423] text-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center justify-center"; 

  return (
    <section className={`${cardMainClasses} p-6 sm:p-8 md:p-10 flex flex-col lg:flex-row items-center lg:items-start gap-6 sm:gap-8`}>
      ...
      <div className="lg:w-64 w-full flex justify-center lg:justify-end">
        <div className={`${rightBoxBgClasses} h-48 w-64 sm:h-56 sm:w-72 md:h-64 md:w-80`}>
          {service.icon && (
            <Image
              src={service.icon}
              alt={service.title}
